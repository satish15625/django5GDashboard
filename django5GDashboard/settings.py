"""
Django settings for django5GDashboard project.
...
TEMPLATES = [
    {
        ...
        'APP_DIRS': True,  # Enables Django to look inside app templates
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'django5GDashboard.wsgi.application'
